...
def check_data(raw_config: dict[str, typing.Any]) -> None: 
    if len(raw_config) < 6:
        raise ValueError("Error: there must be at least 6 keys in the <config_file>.")
    mandatory_keys: list[str] = ["WIDTH", "HEIGHT", "ENTRY", "EXIT", "OUTPUT_FILE", "PERFECT"]
