...
def generate_wilson(grid: List[List[Cell]],
    ...
    ----------
    grid : List[List[Cell]]
        the grid of Cells to carve into (already built,
    ...
    rng : random.Random
        the seeded random generator to use for all randomness.
    """
...
def non_perfect(grid: List[List[Cell]],
    ...
    ----------
    grid : List[List[Cell]]
        the grid of Cells, already carved into a perfect maze
        by generate_wilson.
    width : int
        the maze's width in cells.
    height : int
...
def _walkable_neighbors(cell: Cell,
    ...
    ----------
    cell : Cell
        the cell to find walkable neighbors from.
    grid : List[List[Cell]]
        the fully generated grid of Cells.
    width : int
        the maze's width in cells.
    height : int
        the maze's height in cells.
